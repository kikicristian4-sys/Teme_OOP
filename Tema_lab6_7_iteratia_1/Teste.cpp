...
void Teste::Test_service(Service& service)
{
	...
	assert(service.adauga_carte_service(-1, "A", "Big Man", "Documentary", 1999) == -10);
	assert(service.adauga_carte_service(1, "A", "Big Man", "Documentary", -1999) == -30);
	assert(service.adauga_carte_service(1, "A", "Big Man", "Documentary", 6000) == -40);
	...
	assert(service.modificare_an_aparitie_service(10, -2000) == -30);
	assert(service.modificare_an_aparitie_service(-10, 2000) == -10);
	...
	assert(service.filtrare_dupa_an_aparitie(-1900) == -30);
	...
	assert(service.cautare_carte_specifica_service("A", "Big Man", "Documentary", -1999) == -30);
	...
	assert(service.sterge_carte_service(-2) == -10);
