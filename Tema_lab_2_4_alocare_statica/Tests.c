...
void Test_creaza_vector_gol_si_distrugere()
{
...
{	
	...
	assert(adaugare_produs(vector, 101, "Armaghedon", "Dan", "Hercule", 102.5, 20) == 0);
	assert(adaugare_produs(vector,102, "Armaghedon", "Dan", "Hercule", 102.5, 22) == 0);
	assert(adaugare_produs(vector, 102, "Armaghedo", "Dan", "Hercule", 102.5, 22) == 5);
	assert(adaugare_produs(vector, 102, "Armaghedon", "Dar", "Hercule", 102.5, 22) == 5);
	assert(adaugare_produs(vector, 102, "Armaghedon", "Dan", "Hercula", 102.5, 22) == 5);
	assert(adaugare_produs(vector, 102, "Armaghedon", "Dan", "Hercule", 102, 22) == 5);
	assert(adaugare_produs(vector,103, "Armaghedon", "Dn", "Hercule", 10, 20) == 0);
	assert(adaugare_produs(vector,102, "Armaghedon", "Dan", "Hercule", 102.5, 20) == 1);
	assert(adaugare_produs(vector, 102, "Armaghedon", "Dan", "Hercule", -102.5, 20) == 3);
	assert(adaugare_produs(vector, -102, "Armaghedon", "Dan", "Hercule", 102.5, 20) == 2);
	assert(adaugare_produs(vector, 102, "Armaghedon", "Dan", "Hercule", 102.5, -20) == 4);
	vector -> lungime = 100;
	assert(adaugare_produs(vector, 106, "Armaghedon", "Dan", "Hercule", 102.5, 20) == 6);
	vector -> lungime = 3;
...
*/
{
	Test_creaza_vector_gol_si_distrugere();
